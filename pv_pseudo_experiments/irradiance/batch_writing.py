        ...
        while True:
            try:
                for i, batch in enumerate(self.dataloader):
                    ...
                    while os.path.exists(f"/mnt/storage_u2_4tb_a/irradiance/{'test' if testing else 'train'}_{count}.npy"):
                        count += 1
                    np.save(f"/mnt/storage_u2_4tb_a/irradiance/{'test' if testing else 'train'}_{count}.npy", batch)
            except:
                datapipe = pseudo_irradiance_datapipe(
